            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" class="d-flex" enctype="multipart/form-data" action="success.php">
                        <div class="mb-3">
                            <label for="experienceCertificate" class="form-label"><strong>Experience
                                    Certificate</strong> </label>
                            <input type="file" class="form-control mt-2" id="experienceCertificate"
                                accept=".pdf, .doc, .docx" name="experienceCertificate[]">
